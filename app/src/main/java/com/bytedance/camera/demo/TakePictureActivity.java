...
public class TakePictureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_picture).setOnClickListener(v -> {
            if (Upermission.isPermissionsReady(TakePictureActivity.this, permissions)) {
                takePicture();
            } else {
                Upermission.reuqestPermissions(TakePictureActivity.this, permissions, REQUEST_EXTERNAL_STORAGE);
            }
        });
